# Generated by Powerlevel10k configuration wizard on 2020-04-15 at 15:27 PDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 20557.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, vertical separators, round heads, round tails, 2 lines, dotted, left frame,
# dark-ornaments, sparse, many icons, concise, transient_prompt, instant_prompt=off.
...
() {
  ...
  function my_git_formatter() {
    ...
    # --NOTE-- THIS IS WHERE I DEAL WITH BRANCH NAME LENGTH
